...
class MySQLDataDriver extends EntityModelDataDriver
{
	...
	public function count( $entityType ) 
	{
		...
		return $this->query("select count(*) c from `{$entityType}`")->toCell();
	}
	
	
	public function delete( $entityType , $entityMixed ) 
	{
