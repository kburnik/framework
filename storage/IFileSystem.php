...
interface IFileSystem 
{
	...
	public function clearstatcache( $clear_realpath_cache = false ,  $filename = null);
	...
	public function parse_ini_string( $ini, $process_sections = false, $scanner_mode = INI_SCANNER_NORMAL );
