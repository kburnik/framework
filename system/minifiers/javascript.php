...
if (strpos($filename,'.min.')>0 || strpos("_".$filename,'ckeditor.js')>0) {
...
// $signature = "/* $orig_filename :: Compressed $ratio% @ $worktime ms :: Js Minifier :: JSMIN Copyright (c) 2002 Douglas Crockford  (www.crockford.com) : */\n";
